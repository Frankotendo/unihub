      ...
      {result && (
        <div className="bg-[#0f172a] p-10 md:p-14 rounded-[4rem] text-white shadow-2xl animate-in slide-in-from-bottom-10 duration-700 border-t-8 border-indigo-600 relative overflow-hidden">
           <div className="relative z-10">
              ...
              <div className="text-slate-200 font-medium leading-[2] whitespace-pre-wrap text-[15px] bg-white/5 p-8 md:p-10 rounded-[2.5rem] border border-white/5 shadow-inner">
                {result}
              </div>
              <div className="flex flex-wrap gap-4 mt-12">
                <button onClick={() => {navigator.clipboard.writeText(result); alert('Copied!')}} className="bg-indigo-600 hover:bg-indigo-500 text-white px-10 py-5 rounded-[1.5rem] text-[10px] font-black uppercase tracking-widest transition-all shadow-xl">
                  Copy Report
                </button>
              </div>
           </div>
